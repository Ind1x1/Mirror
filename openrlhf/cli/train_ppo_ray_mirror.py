...
from openrlhf.trainer.mirror import batch_vllm_engine_call, create_vllm_engines
from openrlhf.trainer.mirror.rayppoworker.launcher import (
    PPORayActorGroup,
    ReferenceModelRayActor,
    RewardModelRayActor,
)
from Mirror.openrlhf.trainer.mirror.rayppoworker.mirror_actor import ActorModelRayActor
from openrlhf.trainer.mirror.rayppoworker.mirror_critic import CriticModelRayActor
...
def train(args):
    ...
    if args.vllm_num_engines is not None and args.vllm_num_engines > 0:
        ...
        if args.agent_func_path:
            from openrlhf.trainer.mirror.rayppoworker.mirror_vllm_engine_async import LLMRayActorAsync as LLMRayActor
        else:
            from openrlhf.trainer.mirror.rayppoworker.mirror_vllm_engine import LLMRayActor
    ...
    if args.async_train:
        from openrlhf.trainer.mirror.ppo_trainer_async import PPOTrainerAsync as PPOTrainer
    else:
        from openrlhf.trainer.mirror.ppo_trainer import PPOTrainer
